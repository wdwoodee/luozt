...
class DeviceData_out():
    ...
    def conn(self):
            global connetion
            connetion=pymongo.MongoClient('10.10.5.9',27017)
    ...
    def find_db(self,dbname,table1,table2,table3,path,flag1,discover_name):
            ...
            type1=table11.find({},{type:'True',sourceId:'True',devId:'True',content:'True',fileId:'True',subName:'True',name:'True'},no_cursor_timeout=True)
                ...
                if fileId not in key1:
                 ...
                 if  sourceId not in key1:
                   ...
                   for b in table22:
                                   ...
                                   if (a[u'devId']==c[u'_id']):
                                       if(ty==arpTable):
                                           ...
                                           if "subName" in key1:
                                               ...
                                               filename=str(hostname+"$$"+"default-live.oat").replace("X","XX").replace("*","XD").replace("/","XA").replace(":","XC").replace("<","XG").replace(">","XH").replace("|","XI").replace("\\","XB").replace("?","XE").replace('"','XF')
                                               hostname4=path2+"\\"+filename
                                               with open(hostname4,'w') as f2:
                                                 f2.write(a[u'content'])
                                       elif(ty==cdpTable):
                                           ...
                                           if "subName" in key1:
                                               ...
                                               filename=str(hostname+"$$"+"default-live.cdp").replace("X","XX").replace("*","XD").replace("/","XA").replace(":","XC").replace("<","XG").replace(">","XH").replace("|","XI").replace("\\","XB").replace("?","XE").replace('"','XF')
                                               hostname4=path2+"\\"+filename
                                               with open(hostname4,'w') as f2:
                                                 f2.write(a[u'content'])
                                       elif(ty==routeTable):
                                           ...
                                           if "subName" in key1:
                                               ...
                                               filename=str(hostname+"$$"+"default-live.ort").replace("X","XX").replace("*","XD").replace("/","XA").replace(":","XC").replace("<","XG").replace(">","XH").replace("|","XI").replace("\\","XB").replace("?","XE").replace('"','XF')
                                               hostname4=path2+"\\"+filename
                                               with open(hostname4,'w') as f2:
                                                 f2.write(a[u'content'])
                                       elif(ty==showCommand):
                                               ...
                                               filename=str(hostname+"$0$"+hostname_vrf+".txt").replace("X","XX").replace("*","XD").replace("/","XA").replace(":","XC").replace("<","XG").replace(">","XH").replace("|","XI").replace("\\","XB").replace("?","XE").replace('"','XF')
                                               hostname4=path2+"\\"+filename
                                               with open(hostname4,'w') as f2:
                                                 f2.write(a[u'content'])
                                       elif(ty==config):
                                               hostname=str(c[u'name']).replace("X","XX").replace("*","XD").replace("X","XX").replace("*","XD").replace("/","XA").replace(":","XC").replace("<","XG").replace(">","XH").replace("|","XI").replace("\\","XB").replace("?","XE").replace('"','XF')
                                           ...
                                           if "subName" in key1:
                                               ...
                                               filename=str(hostname+"$$"+"default-live.stp").replace("X","XX").replace("*","XD").replace("/","XA").replace(":","XC").replace("<","XG").replace(">","XH").replace("|","XI").replace("\\","XB").replace("?","XE").replace('"','XF')
                                               hostname4=path2+"\\"+filename
                                               with open(hostname4,'w') as f2:
                                                 f2.write(a[u'content'])
                                       elif(ty==bgpNbrTable):
                                           ...
                                           if "subName" in key1:
                                               ...
                                               filename=str(hostname+"$"+hostname_ip+"$"+"default-live.obgprt").replace("X","XX").replace("*","XD").replace("X","XX").replace("*","XD").replace("/","XA").replace(":","XC").replace("<","XG").replace(">","XH").replace("|","XI").replace("\\","XB").replace("?","XE").replace('"','XF')
                                               hostname4=path2+"\\"+filename
                                               with open(hostname4,'w') as f2:
                                                 f2.write(a[u'content'])
                                       elif(ty==nctTable):
                                               ...
                                               filename=str(hostname+"$$"+hostname_name+".csv").replace("X","XX").replace("*","XD").replace("X","XX").replace("*","XD").replace("/","XA").replace(":","XC").replace("<","XG").replace(">","XH").replace("|","XI").replace("\\","XB").replace("?","XE").replace('"','XF')
                                               hostname4=path2+"\\"+filename
                                               with open(hostname4,'w') as f2:
                                                 f2.write(a[u'content'])
                    ...
                    for b in bb:
                        if(a[u'sourceId']==b[u'_id']):
                           b1=str(b[u'startTime']).replace("X","XX").replace("*","XD").replace("X","XX").replace("*","XD").replace("/","XA").replace(":","XC").replace("<","XG").replace(">","XH").replace("|","XI").replace("\\","XB").replace("?","XE").replace('"','XF')
                           path1=path+"\\"+b1
                           if not os.path.exists(path1):
                               os.mkdir(path1)
                           fileid=a[u'fileId']
