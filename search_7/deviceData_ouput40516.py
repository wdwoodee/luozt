...
class DeviceData_out():
    ...
    def conn(self):
            global connetion
            connetion=pymongo.MongoClient('10.10.5.252',27019)
    ...
    def find_db(self,dbname,table1,table2,table3,path,flag1,discover_name):
            ...
            dis_benchID='2c57ce19-5ec1-4c16-a55d-4c750131787b'
           ...
           # device_type=['cdpTable','cdpTableOrig','arpTable','arpTableOrig','macTable','macTableOrig']
            for k in device_type:
                    type1=table11.find({type:k},{type:1,sourceId:1,devId:1,content:1,fileId:1,subName:1,name:1},no_cursor_timeout=True)
